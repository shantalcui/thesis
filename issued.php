...
$tender=$trowzs['user_tender'];
           ...
           ?>
                ...
                <li class="top row d-flex pt-3 justify-content-between">
                  ...
                  <small class="col-5 font-weight-bold text-right">Php <?php echo $vatt;?><!--(VAT=AMOUNT*0.12)--><!--PAG MAY SENIOR DISCOUNT PHP0.00 NA YUNG VAT--></small>
                </li>
                <!-- DISCOUNT -->
                <li class="row d-flex justify-content-between">
                  <small class="col font-weight-bold text-right">Discount 20%</small>
                  <small class="col-5 font-weight-bold text-right">Php <?php echo $discc;?><!--(DISCOUNT=AMOUNT*0.2)--></small>
                </li>
                <!-- TOTAL AMOUNT -->
                <li class="row d-flex mb-n2 justify-content-between">
                  <h5 class="col font-weight-bold text-right">AMOUNT</h5>
                  <h5 class="col-5 font-weight-bold text-right">Php <?php echo $amc;?> <!--(SUBTOTAL+VAT)--> <!--PAG MAY SENIOR DISCOUNT: (SUBTOTAL-DISCOUNT)--></h5>
                </li>

                <li class="row d-flex justify-content-between">
                  <small class="col font-weight-bold text-right">Amount Tendered</small>
                  <small class="col-5 font-weight-bold text-right">Php <?php echo $tender;?><!--(DISCOUNT=AMOUNT*0.2)--></small>
                </li>

                <li class="bottom row pb-3 d-flex justify-content-between">
                  <small class="col font-weight-bold text-right">Change</small>
                  <small class="col-5 font-weight-bold text-right">Php <?php echo $Change;?><!--(DISCOUNT=AMOUNT*0.2)--></small>
                </li>
